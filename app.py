...
# إعدادات الواجهة (تم تصحيح الفواصل والأسطر هنا)
...
def fix_arabic_swaps(text):
    if not text: return ""
    corrections = {
        "حنس": "حسن", "raiyadh": "رياض", "رايض": "رياض", "اثري": "اثير", "حسني": "حسين", "الحسني": "الحسين",
...
fix_reversed = st.checkbox("🔄 تفعيل مصحح ومطهر الأسماء الذكي التلقائي", value=True)
