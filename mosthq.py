...
# -----------------------------------------------------------------------------
# 2. محرك الاستخراج الدقيق (للنماذج 1، 2، و3)
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# 2.5. محرك الاستخراج المخصص للنموذج الرابع (المستحق فقط)
# -----------------------------------------------------------------------------
    ...
    if len(uploaded_files) == 2:
        with st.spinner('جاري التحليل وعزل الحالات تلقائياً...'):
            ...
            if comparison_mode == "النموذج الرابع (المستحق فقط)":
                old_data = extract_eligible_only_records(old_doc)
                new_data = extract_eligible_only_records(new_doc)
